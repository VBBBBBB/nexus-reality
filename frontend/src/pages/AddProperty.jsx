    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={submit} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
          ...
          <div style={{ gridColumn: "1 / -1" }}>
            <label style={{ display: "block", marginBottom: "8px", fontWeight: "500", color: "#555" }}>Upload Images (Select multiple)</label>
            <input type="file" name="images" accept="image/*" multiple onChange={handleFileChange} required style={inputStyle} />
            {images.length > 0 && (
              <p style={{ fontSize: "12px", color: "#64748b", marginTop: "5px" }}>{images.length} images selected</p>
            )}
          </div>
